    ...
    return(
        <main>
            <section className="flex justify-between p-5 bg-black/30 rounded-lg items-center">
                <section className="w-12 h-12 rounded-full flex justify-center items-center shadow-md bg-white/20 items-center align-center">
                    <div className="text-white text-2xl font-semibold ">N</div>
                </section>
